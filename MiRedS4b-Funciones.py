...
def mostrar_perfil(nombre, edad, estatura_m, estatura_cm, num_amigos, tu_genero, tu_pais ):
    print("--------------------------------------------------")
    print("Nombre:   ", nombre)
    print("Edad:     ", edad, "años")
    print("Estatura: ", estatura_m, "m y ", estatura_cm, "centímetros")
    print("Amigos:   ", num_amigos)
    print("Genero:   ", tu_genero)
    print("Pais:     ", tu_pais)
    print("--------------------------------------------------")
...
tu_genero = obtener_genero()
tu_pais = obtener_pais()
print("Muy bien,", nombre, ". Entonces podemos crear un perfil con estos datos.")
mostrar_perfil(nombre, edad, estatura_m, estatura_cm, num_amigos, tu_genero, tu_pais)
