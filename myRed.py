...
def cal_estatura_m(m):
    estatura_m = int(m)
    return estatura_m

def cal_estatura_cm(cm):
    estatura_cm = int( (cm - cal_estatura_m(estatura))*100 )
    return  estatura_cm
...
print("--------------------------------------------------")
print("Nombre:  ", nombre)
print("Edad:    ", cal_edad(agno), "aÃ±os")
print("Estatura:", cal_estatura_m(estatura), "metros y", cal_estatura_cm(estatura), "centÃ­metros")
...
while opcion != 0:
    ...
    #CÃ³digo para la opciÃ³n 3. Publicar los datos del perfil del usuario.
        ...
        print("Nombre:   ", nombre)
        print("Edad:     ", cal_edad(agno), "aÃ±os")
        print("Estatura: ", cal_estatura_m(estatura), "m y ", cal_estatura_cm(estatura), "centÃ­metros")
        print("Amigos:   ", num_amigos)
        print("--------------------------------------------------")
